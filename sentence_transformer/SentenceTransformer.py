    ...
    def fit(self,
        ...
        for epoch in trange(epochs, desc="Epoch", disable=not show_progress_bar):
            ...
            for _ in trange(steps_per_epoch, desc="Iteration", smoothing=0.05, disable=not show_progress_bar):
                loss_value_cumulative = 0 # extra line
                ...
                for train_idx in range(num_train_objectives):
                    ...
                    loss_value_cumulative += loss_value # extra line
                ...
                if loss_value_cumulative: # extra if
                    run['train/loss'].append( loss_value_cumulative / num_train_objectives )
            ...
            if training_samples: # extra if
                similarity_evaluator = EmbeddingSimilarityEvaluator.from_input_examples(
                    training_samples, batch_size=evaluator.batch_size, main_similarity=SimilarityFunction.COSINE
                )
